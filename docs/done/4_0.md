...
* [x] Check byte vs utf changes
ANSWER : https://www.quora.com/How-is-UTF-8-different-from-ASCII-when-they-have-8-bit-storage-block
    -> It is ok to simply iterate through

* [x] Simply ditch all logics of define parsing.
    * [x] Remove struct and make it a singular function
    * [x] Check name validity inside util function
    * [x] Change parse-define to return &str not a string
...
* [x] Put line ending option for --stream-lines : --put-newline or --pn
* [x] Early return
