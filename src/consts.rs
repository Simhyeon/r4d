...
#[cfg(windows)]
pub(crate) const DEFAULT_RADIT_EDITOR: &str = "notepad.exe";
#[cfg(not(windows))]
pub(crate) const DEFAULT_RADIT_EDITOR: &str = "vim";

lazy_static::lazy_static! {
    pub static ref RADIT_READ_TEMP_DIR: std::path::PathBuf = std::env::temp_dir().join("rado");
}
