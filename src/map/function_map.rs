...
[(ArgType::Text,"a_pattern"),(ArgType::Text, "a_content"),],
            ...
            (
                FMacroSign::new(
                    "pad",
[(ArgType::Text,"a_type"),(ArgType::Text,"a_width"),(ArgType::Text,"a_fill"),(ArgType::Text,"a_text"),],
                    Self::pad_string,
            ...
            (
                FMacroSign::new(
                    "peel",
[(ArgType::Text,"a_level"),(ArgType::Text,"a_src"),],
                    Self::peel,
            ...
            (
                FMacroSign::new(
                    "align",
[(ArgType::Text,"a_align_type"),(ArgType::Text, "a_content"),],
                    Self::align,
...
[(ArgType::Text,"a_content"),],
            ...
            (
                FMacroSign::new(
                    "rangeu",
[(ArgType::Text,"a_min^"),(ArgType::Text, "a_max^"),(ArgType::Text, "a_array"),],
                    Self::substring_utf8,
...
[(ArgType::Text,"a_sep"),(ArgType::Text, "a_text"),],
            ...
            (
                FMacroSign::new(
                    "strip",
[(ArgType::Text,"a_count^"),(ArgType::Text,"a_content"),],
                    Self::strip,
...
[(ArgType::Text,"a_border_string"),(ArgType::Text,"a_content"),],
            ...
            (
                FMacroSign::new(
                    "cut",
[(ArgType::Text,"a_sep"),(ArgType::Text, "a_index"),(ArgType::Text,"a_text"),],
                    Self::split_and_cut,
            ...
            (
                FMacroSign::new(
                    "cont",
[(ArgType::Text,"a_op"),(ArgType::Text,"a_arg"),],
                    Self::container,
                    None
                )
            ),
            (
                FMacroSign::new(
                    "scut",
[(ArgType::Text,"a_index"),(ArgType::Text,"a_text"),],
...
[(ArgType::Text,"a_macro_names^"),],
            ...
            (
                FMacroSign::new(
                    "docu",
[(ArgType::Text,"a_macro_name^"),(ArgType::Text, "a_doc"),],
                    Self::document,
...
[(ArgType::Text,"a_file_name^"),],
            ...
            (
                FMacroSign::new(
                    "inc",
[(ArgType::Text,"a_number^"),(ArgType::Text,"a_amount?^"),],
...
[(ArgType::Text,"a_number^"),],
            ...
            (
                FMacroSign::new(
                    "inner",
[(ArgType::Text,"a_rule^"),(ArgType::Text,"a_count^"),(ArgType::Text,"a_src"),],
                    Self::get_inner,
...
[(ArgType::Text,"a_indenter"),(ArgType::Text, "a_lines"),],
            ...
            (
                FMacroSign::new(
                    "index",
[(ArgType::Text,"a_index^"),(ArgType::Text, "a_array"),],
                    Self::index_array,
...
$assert(ef,$index(2,ab,cd,ef))".to_string()),
            ...
            (
                FMacroSign::new(
                    "indexl",
[(ArgType::Text,"a_index^"),(ArgType::Text, "a_lines"),],
                    Self::index_lines,
...
[(ArgType::Text,"a_string"),],
            ...
            (
                FMacroSign::new(
                    "let",
[(ArgType::Text,"a_macro_name^"),(ArgType::Text, "a_value^"),],
                    Self::bind_to_local,
...
$assert($nl(),
            ...
            (
                FMacroSign::new(
                    "notat",
[(ArgType::Text,"a_number^"),(ArgType::Text, "a_type^"),],
...
$assert(Text,$-())".to_string()),
            ...
            (
                FMacroSign::new(
                    "pipeto",
[(ArgType::Text,"a_pipe_name^"),(ArgType::Text, "a_value"),],
                    Self::pipe_to,
...
$assert($-(yum),YUM)".to_string()),
            ...
            (
                FMacroSign::new(
                    "prec",
[(ArgType::Text,"a_number^"),(ArgType::Text, "a_precision^"),],
                    Self::prec,
...
[(ArgType::Text,"a_message"),],
            ...
            (
                FMacroSign::new(
                    "relay",
[(ArgType::Text,"a_target_type^"),(ArgType::Text, "a_target^"),],
                    Self::relay,
                    Some(
...
$assert(Hello Rust,$sub(World,Rust,Hello World))".to_string()),
            ...
            (
                FMacroSign::new(
                    "addexpr",
[(ArgType::Text,"a_name"),(ArgType::Text, "a_expr"),],
...
$assert(false,$find(greeting,greetings from world))".to_string()),
            ...
            (
                FMacroSign::new(
                    "rename",
[(ArgType::Text,"a_macro_name^"),(ArgType::Text, "a_new_name^"),],
                    Self::rename_call,
...
$assert($demo(),Test)".to_string()),
            ...
            (
                FMacroSign::new(
                    "repeat",
[(ArgType::Text,"a_count^"),(ArgType::Text, "a_source"),],
                    Self::repeat,
...
R4d,$repeat^(3,R4d$nl()))".to_string()),
            ...
            (
                FMacroSign::new(
                    "repl",
[(ArgType::Text,"a_macro_name^"),(ArgType::Text, "a_new_value"),],
                    Self::replace,
...
$require(fin,fout)".to_string()),
            ...
            (
                FMacroSign::new(
                    "rotatel",
[(ArgType::Text,"a_pattern"),(ArgType::Text, "a_orientation"),(ArgType::Text, "a_content"),],
                    Self::rotatel,
                    None,
                )
            ),
...
$source(def.env)".to_string()),
            ...
            (
                FMacroSign::new(
                    "sort",
[(ArgType::Text,"a_sort_type^"),(ArgType::Text,"a_array"),],
                    Self::sort_array,
                    Some("Sort an array
...
$sort(asec,3,6,7,4,1,9,0))".to_string()),
            ...
            (
                FMacroSign::new(
                    "sortl",
[(ArgType::Text,"a_sort_type^"),(ArgType::Text,"a_lines"),],
                    Self::sort_lines,
                    Some("Sort lines
...
c))".to_string()),
            ...
            (
                FMacroSign::new(
                    "sortc",
[(ArgType::Text,"a_sort_type^"),(ArgType::Text,"a_content"),],
                    Self::sort_chunk,
                    None,
                )
            ),
...
[(ArgType::Text,"a_amount?^"),],
            ...
            (
                FMacroSign::new(
                    "static",
[(ArgType::Text,"a_macro_name^"),(ArgType::Text, "a_expr^"),],
                    Self::define_static,
                    Some(
...
$strict(lenient)".to_string()),
            ...
            (
                FMacroSign::new(
                    "range",
[(ArgType::Text,"a_start_index^"),(ArgType::Text, "a_end_index^"),(ArgType::Text, "a_source"),],
                    Self::substring,
            ...
            (
                FMacroSign::new(
                    "rangel",
[(ArgType::Text,"a_start_index^"),(ArgType::Text, "a_end_index^"),(ArgType::Text, "a_lines"),],
                    Self::range_lines,
                    None
                )
            ),
            (
                FMacroSign::new(
                    "rangeby",
[(ArgType::Text,"a_delimeter"),(ArgType::Text,"a_start_index^"),(ArgType::Text, "a_end_index^"),(ArgType::Text, "a_lines"),],
                    Self::range_pieces,
                    None
                )
            ),
...
c))".to_string()),
            ...
            (
                FMacroSign::new(
                    "table",
[(ArgType::Text,"a_table_form^"),(ArgType::Text, "a_csv_value^"),],
                    Self::table,
                    Some(
    ...
    Middle
          Last))".to_string()),
            ...
            (
                FMacroSign::new(
                    "exdent",
[(ArgType::Text,"a_trim_option^"),(ArgType::Text,"a_lines"),],
                    Self::exdent,
...
$assert(/home/user/dir,$env(HOME))"
            ...
            (
                FMacroSign::new(
                    "envset",
[(ArgType::Text,"a_env_name^"),(ArgType::Text, "a_env_value"),],
                    Self::set_env,
                    Some(
...
$exist(file.txt)"
            ...
            (
                FMacroSign::new(
                    "grepf",
[(ArgType::Text,"a_expr"),(ArgType::Text, "a_file^"),],
                    Self::grep_file,
                    Some(
...
$assert(/tmp/rad.txt,$temp())"
            ...
            (
                FMacroSign::new(
                    "fileout",
[(ArgType::Text,"a_filename^"),(ArgType::Text, "a_truncate?^"),(ArgType::Text, "a_content"),],
                    Self::file_out,
                    Some(
...
$extract()"
        ...
        #[cfg(feature = "cindex")]
        {
            map.macros.insert(
                ...
                FMacroSign::new(
                    "addcsv",
                    [(ArgType::Text, "a_table_name^"), (ArgType::Text, "a_data^")],
...
# Example"
        ...
        map.macros.insert(
            ...
            FMacroSign::new(
                "wrap",
                [(ArgType::Text, "a_width^"), (ArgType::Text, "a_text")],
                Self::wrap,
                Some(
                    "Wrap text by width
        ...
        #[cfg(feature = "hook")]
        {
            map.macros.insert(
                ...
                FMacroSign::new(
                    "hookon",
                    [
                        (ArgType::Text, "a_macro_type^"),
                        (ArgType::Text, "a_target_name^"),
                    ],
                    Self::hook_enable,
